...
import com.mobsandgeeks.demo.CircularSentenceActivity.CustomAdapter;
...
public class CircularListAdapter extends BaseAdapter {
     ...
     */
    public CircularListAdapter(CustomAdapter listAdapter) {
        if(listAdapter == null) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	mListAdapter.realPosition = position;
